...
def test_add_neurons():
    ...
    new_neuron_data.append(
        {'in_neurons': None, 'out_neurons': [3, 5], 'group': 'input', 'dropout_p': 0.}
    )
    new_neuron_data.append(
        {'in_neurons': [0], 'out_neurons': [1, 2], 'group': 'hidden', 'dropout_p': None}
    )
    new_neuron_data.append(
        {'in_neurons': [1], 'out_neurons': None, 'group': 'output', 'dropout_p': 1}
    )
